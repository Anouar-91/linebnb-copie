 ...
 */
class PasswordUpdate extends \App\Entity\PasswordUpdate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\PasswordUpdate' . "\0" . 'id', '' . "\0" . 'App\\Entity\\PasswordUpdate' . "\0" . 'oldPassword', '' . "\0" . 'App\\Entity\\PasswordUpdate' . "\0" . 'newPassword', '' . "\0" . 'App\\Entity\\PasswordUpdate' . "\0" . 'confirmPassword'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PasswordUpdate $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setOldPassword(string $oldPassword): \App\Entity\PasswordUpdate
    {
     ...
     * {@inheritDoc}
     */
    public function setNewPassword(string $newPassword): \App\Entity\PasswordUpdate
    {
     ...
     * {@inheritDoc}
     */
    public function setConfirmPassword(string $confirmPassword): \App\Entity\PasswordUpdate
    {
