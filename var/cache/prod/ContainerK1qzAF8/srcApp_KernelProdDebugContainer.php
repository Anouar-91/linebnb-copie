...
class srcApp_KernelProdDebugContainer extends Container
{
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('tYEc1OtUzN', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ces5Wi8lCu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getCache_AnnotationsService()
    {
        ...
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XEUfXJkGyU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getCache_SecurityExpressionLanguageService()
    {
        ...
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IjhNOTYFBn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getCache_WebpackEncoreService()
    {
        ...
        return $this->privates['cache.webpack_encore'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bwHmVQtYGN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDoctrine_ResultCachePoolService()
    {
        ...
        $this->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('JBuNRNyVBh', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    protected function getDoctrine_SystemCachePoolService()
    {
        ...
        return $this->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rXE7HfjEyT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderfcdd8 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializere6c45 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties170ba = [
        
    ];

    public function getConnection()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getConnection', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getMetadataFactory', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getExpressionBuilder', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'beginTransaction', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->beginTransaction();
    }

    public function getCache()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getCache', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getCache();
    }

    public function transactional($func)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'transactional', array('func' => $func), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->transactional($func);
    }

    public function commit()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'commit', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->commit();
    }

    public function rollback()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'rollback', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getClassMetadata', array('className' => $className), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'createQuery', array('dql' => $dql), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'createNamedQuery', array('name' => $name), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'createQueryBuilder', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'flush', array('entity' => $entity), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'clear', array('entityName' => $entityName), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->clear($entityName);
    }

    public function close()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'close', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->close();
    }

    public function persist($entity)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'persist', array('entity' => $entity), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'remove', array('entity' => $entity), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'refresh', array('entity' => $entity), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'detach', array('entity' => $entity), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'merge', array('entity' => $entity), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getRepository', array('entityName' => $entityName), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'contains', array('entity' => $entity), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getEventManager', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getConfiguration', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'isOpen', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getUnitOfWork', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getProxyFactory', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'initializeObject', array('obj' => $obj), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'getFilters', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'isFiltersStateClean', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'hasFilters', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return $this->valueHolderfcdd8->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializere6c45 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderfcdd8) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderfcdd8 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderfcdd8->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, '__get', ['name' => $name], $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        if (isset(self::$publicProperties170ba[$name])) {
            return $this->valueHolderfcdd8->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderfcdd8;
    ...
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, '__set', array('name' => $name, 'value' => $value), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;
    ...
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, '__isset', array('name' => $name), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;
    ...
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, '__unset', array('name' => $name), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;
    ...
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, '__clone', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        $this->valueHolderfcdd8 = clone $this->valueHolderfcdd8;
    }

    public function __sleep()
    {
        $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, '__sleep', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;

        return array('valueHolderfcdd8');
    }
    ...
    {
        $this->initializere6c45 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializere6c45;
    }

    public function initializeProxy() : bool
    {
        return $this->initializere6c45 && ($this->initializere6c45->__invoke($valueHolderfcdd8, $this, 'initializeProxy', array(), $this->initializere6c45) || 1) && $this->valueHolderfcdd8 = $valueHolderfcdd8;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderfcdd8;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderfcdd8;
    }
}
