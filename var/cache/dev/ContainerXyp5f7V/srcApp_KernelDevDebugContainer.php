...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0hJMV9QekX', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0Bgnf1dR4-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('URK3jTORxS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XhY5ezAJTi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FWBKlFqKX-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cJUL1Fcbr0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nmrh0EsAVd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kc1nxmyXx6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder018b3 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerb5664 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesedc84 = [
        
    ];

    public function getConnection()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getConnection', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getMetadataFactory', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getExpressionBuilder', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'beginTransaction', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getCache', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getCache();
    }

    public function transactional($func)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'transactional', array('func' => $func), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->transactional($func);
    }

    public function commit()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'commit', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->commit();
    }

    public function rollback()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'rollback', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getClassMetadata', array('className' => $className), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'createQuery', array('dql' => $dql), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'createNamedQuery', array('name' => $name), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'createQueryBuilder', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'flush', array('entity' => $entity), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'clear', array('entityName' => $entityName), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->clear($entityName);
    }

    public function close()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'close', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->close();
    }

    public function persist($entity)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'persist', array('entity' => $entity), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'remove', array('entity' => $entity), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'refresh', array('entity' => $entity), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'detach', array('entity' => $entity), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'merge', array('entity' => $entity), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getRepository', array('entityName' => $entityName), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'contains', array('entity' => $entity), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getEventManager', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getConfiguration', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'isOpen', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getUnitOfWork', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getProxyFactory', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'initializeObject', array('obj' => $obj), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'getFilters', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'isFiltersStateClean', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'hasFilters', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return $this->valueHolder018b3->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerb5664 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder018b3) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder018b3 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder018b3->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, '__get', ['name' => $name], $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        if (isset(self::$publicPropertiesedc84[$name])) {
            return $this->valueHolder018b3->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder018b3;
    ...
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;
    ...
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, '__isset', array('name' => $name), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;
    ...
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, '__unset', array('name' => $name), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;
    ...
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, '__clone', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        $this->valueHolder018b3 = clone $this->valueHolder018b3;
    }

    public function __sleep()
    {
        $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, '__sleep', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;

        return array('valueHolder018b3');
    }
    ...
    {
        $this->initializerb5664 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerb5664;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerb5664 && ($this->initializerb5664->__invoke($valueHolder018b3, $this, 'initializeProxy', array(), $this->initializerb5664) || 1) && $this->valueHolder018b3 = $valueHolder018b3;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder018b3;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder018b3;
    }
}
